...
public class HangGameEx1 extends javax.swing.JFrame {
    ...
    /**
     * Creates new form HangGameEx1
     */
    
    static boolean terminate = false, resume = false;
    static int w = 0, l = 0;
    ...
    public void algorithm(){
        ...
        boolean flag = false;
            ...
            display1.setText( "The correct letters you have entered so far \n"+guessit);
            ...
            while(gameflag) 
            {
                ...
                do
                {
                    ...
                    do 
                    {
                        ...
                        if(guess.equals(""))
                          JOptionPane.showMessageDialog(this,"Please enter a Alphabet","WARNING",1);
                        else
                            flag = true;
                           gameflag = true;
                           System.out.println("got the name "+guess);
                        }
                    ...
                    if(gameflag) 
                    {
                        ...
                        //break;
                        System.out.println("Inside the else condition of Input class");
                        break;
                    }  
                    ...
                    {
                        System.out.println("Inside for loop "+" i = "+i + "length = "+len);
                        try
                        {
                    ...
                    if(checkguess == 1)
                    {
                        display1.setText("Correct Guess. You have " + counter + " guess(es) left\n");
                    ...
                    else
                    {
                        ...
                        if(counter == 0)
                        {
                            display1.setText("Wrong guess. You hanged the man :(\n");
                        ...
                        {
                            display1.setText("Wrong guess. You have " + counter + " guess(es) left\n");
                    ...
                    {
                        display1.append("You guessed the word!!!!!");
                        display1.append("-----------------------------------");
                        w++;
                        counter=0;
                        jButton3.setEnabled(true);
                ...
                System.out.println("before breaking away from the game.....");
                break;
            }
            //terminate program
    ...
    public String[] Sports()
    {
       ...
       String B []= A[i];
       System.out.println("before returning the game....."+A[i][0].toString());
